        ...
        <>
            ...
            <div className={styles.navbar}>
                <div className={styles.navbar_box}>
                    ...
                    <div className={styles.menu}>
                        ...
                        <Link href={{ pathname: 'transactionHistory' }}>
                            <a className={`${styles.link} ${isActiveLink('/transactionHistory')}`}>Transaction History</a>
                        </Link>
            ...
            <div className={styles.mobileBottomNav}>
                ...
                <Link href="/transactionHistory">
                    <div className={`${styles.navItem} ${isActive('/transactionHistory')}`}>
                        <svg viewBox="0 0 24 24">
